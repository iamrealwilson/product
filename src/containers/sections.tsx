		...
		<React.Fragment>
			<Show.Sections>
				{userDetails != null && (userDetails.email == "dolo@law.com" || userDetails.email == "culpa@law.com" || userDetails.email == "c@c.com" || userDetails.email == "first@law.com" || userDetails.email == "law@law.com" || userDetails.email == "crim@law.com" || userDetails.email == "rcriminal@law.com" || userDetails.email == "dcriminal@law.com" || userDetails.email == "qcriminal@law.com") 
				 ...
				 :
				 {userDetails != null && (userDetails.email == "regular102@legallex.com" ) 
				 ? 
				 SECTIONS[category].sections.filter(section => section.title.includes("Criminal")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})
				:
				 userDetails != null && (userDetails.email === "kaydiesto@gmail.com")
				 ?
				 ...
				 userDetails.email === "lmt37@law.com" ||
				 userDetails.email === "lmt38@law.com" ||
				 userDetails.email === "lmt39@law.com" ||
				 ...
				 userDetails.email === "lmt64@law.com" ||
				 userDetails.email === "lmt65@law.com" ||
				 ...
				 userDetails.email === "lmt80@law.com" || 
				 userDetails.email === "lmt81@law.com" ||
				 userDetails.email === "lmt82@law.com" ||
				 userDetails.email === "lmt83@law.com" ||
				 userDetails.email === "lmt84@law.com" ||
				 userDetails.email === "lmt85@law.com" ||
				 userDetails.email === "lmt86@law.com" ||
				 userDetails.email === "lmt87@law.com" ||
				 userDetails.email === "lmt88@law.com" ||
				 userDetails.email === "lmt89@law.com" ||
				 userDetails.email === "lmt90@law.com" ||
				 userDetails.email === "lmt91@law.com" ||
				 userDetails.email === "lmt92@law.com"				 
				 )
				 ?
				 ...
				 :
				 userDetails != null && (userDetails.email === "preweek@80")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 userDetails != null && (userDetails.email === "preweek@82")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Remedial") || section.title.includes("Preweek - Civil") || section.title.includes("Preweek - Criminal")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 userDetails != null && (userDetails.email   === "preweek@83")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Tax") || section.title.includes("Preweek - Remedial") || section.title.includes("Preweek - Labor") || section.title.includes("Preweek - Criminal")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 userDetails != null && (userDetails.email   === "preweek@84")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Tax") || section.title.includes("Preweek - Remedial") || section.title.includes("Preweek - Labor") || section.title.includes("Preweek - Criminal")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 userDetails != null && (userDetails.email   === "preweek@85")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Criminal")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 userDetails != null && (userDetails.email   === "preweek@86")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Criminal")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 userDetails != null && (userDetails.email   === "preweek@87")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Commercial")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 userDetails != null && (userDetails.email   === "preweek@88")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Criminal")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 userDetails != null && (userDetails.email   === "preweek@89")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Commercial") || section.title.includes("Preweek - Remedial")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 userDetails != null && (userDetails.email   === "preweek@91")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 userDetails != null && (userDetails.email   === "preweek@92")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Political") || section.title.includes("Preweek - Commercial") || section.title.includes("Preweek - Remedial") || section.title.includes("Preweek - Civil") || section.title.includes("Preweek - Criminal")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 userDetails != null && (userDetails.email   === "preweek@93")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Civil")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 userDetails != null && (userDetails.email   === "preweek@94")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Criminal") || section.title.includes("Preweek - Taxation") ).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 userDetails != null && (userDetails.email   === "preweek@95")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Criminal") || section.title.includes("Preweek - Taxation") ).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 userDetails != null && (userDetails.email   === "preweek@96")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Commercial") || section.title.includes("Preweek - Criminal") || section.title.includes("Preweek - Remedial") ).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 userDetails != null && (userDetails.email   === "preweek@100")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 userDetails != null && (userDetails.email   === "preweek@101")
				 ?
				 ...
				 :
				 userDetails != null && (userDetails.email   === "preweek@105")
				 ?
				 SECTIONS[category].sections.filter(section =>  section.title.includes("Preweek - Criminal")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 userDetails != null && (userDetails.email   === "preweek@106")
				 ?
				 ...
				 :
				 userDetails != null && (userDetails.email   === "preweek@107")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Labor") || section.title.includes("Preweek - Criminal")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 userDetails != null && (userDetails.email   === "preweek@108")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Commercial") || section.title.includes("Preweek - Taxation")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 ...
				 :
				 userDetails != null && (userDetails.email   === "preweek@113")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Civil") || section.title.includes("Preweek - Criminal")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 ...
				 :
				 userDetails != null && (userDetails.email === "lorendelossantos0730@gmail.com")
				 ?
				 SECTIONS[category].sections.filter(section =>  section.title.includes("Civil")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 userDetails != null && (userDetails.email === "jallysamndz@gmail.com")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Commercial") || section.title.includes("Political") || section.title.includes("Taxation") || section.title.includes("Remedial") || section.title.includes("Criminal")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 userDetails != null && (userDetails.email === "preweek@65")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 userDetails != null && (userDetails.email === "preweek@66")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Criminal")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 :
				 userDetails != null && (userDetails.email === "preweek@67")
				 ?
				 SECTIONS[category].sections.filter(section =>  section.title.includes("Preweek - Criminal")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})	
				 ...
				 :
				 userDetails != null && (userDetails.email === "preweek@64")
				 ?
				 SECTIONS[category].sections.filter(section => 	 section.title.includes("Preweek - Civil") || section.title.includes("Preweek - Criminal") || section.title.includes("Preweek - Commercial")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})
				 :
				 ...
				 :
				 userDetails != null && (userDetails.email === "CA_adeth@yahoo.com")
				 ?
				 ...
				 ?
				 SECTIONS[category].sections.filter(section =>  section.title.includes("Preweek - Commercial") || section.title.includes("Preweek - Remedial") || section.title.includes("Preweek - Labor") || section.title.includes("Preweek - Civil") || section.title.includes("Preweek - Taxation") || section.title.includes("Preweek - Criminal")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})
				 :
				 ...
				 :
				 userDetails != null && (userDetails.email === "preweek@53")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Labor") || section.title.includes("Preweek - Commercial") || section.title.includes("Preweek - Taxation") || section.title.includes("Preweek - Civil")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})
				 :
				 userDetails != null && (userDetails.email === "preweek@54")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Criminal")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})
				 ...
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Taxation") || section.title.includes("Preweek - Legal") || section.title.includes("Preweek - Political") || section.title.includes("Preweek - Commercial") || section.title.includes("Preweek - Remedial") || section.title.includes("Preweek - Labor") || section.title.includes("Preweek - Civil") || section.title.includes("Preweek - Criminal")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})
				 :
				 userDetails != null && (userDetails.email === "preweek@59")
				 ?
				 ...
				 :
				 userDetails != null && (userDetails.email === "preweek@60")
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Legal Ethics") || section.title.includes("Preweek - Commercial") || section.title.includes("Preweek - Civil") || section.title.includes("Preweek - Criminal")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})
				 :
				 userDetails != null && (userDetails.email === "preweek@61")
				 ?
				 ...
				 :
				 userDetails != null && (userDetails.email === "preweek@62")
				 ?
				 ...
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Civil") || section.title.includes("Preweek - Tax") || section.title.includes("Preweek - Criminal")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})
				 :
				 ...
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek - Civil") || section.title.includes("Preweek - Remedial") || section.title.includes("Preweek - Criminal")).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})
				 :
				...
				SECTIONS[category].sections.filter(section => section.title.includes("Civil") || section.title.includes("Commercial") || section.title.includes("Remedial") || section.title.includes("Political") || section.title.includes("Criminal")).map((section, i) => {
				 ...
				 ?
				 SECTIONS[category].sections.filter(section => section.title.includes("Preweek") || section.title.includes("Commercial") || section.title.includes("Civil") || section.title.includes("Criminal") || section.title.includes("Remedial") || section.title.includes("Political") || section.title.includes("Taxation") ).map((section, i) => {
								return i < sectionDisplayed && <SliderContainer key={section.title} section={section} />;
							})			
				 :
